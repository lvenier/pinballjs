function CCreditsPanel() {
    ...
    this._init = function () {
        ...
        var iTextX = 0;
        var iTextY = -90;
        var oTitle = new CTLText(_oPanelContainer, iTextX - iWidth / 2, iTextY - iHeight / 2, iWidth, iHeight, 40, "center", PRIMARY_FONT_COLOUR, PRIMARY_FONT, 1.3, 2, 2, TEXT_DEVELOPED, true, true, true, false);
        var iWidth = 400;
        var iHeight = 60;
        var iTextX = 0;
        var iTextY = 70;
        var oLink = new CTLText(_oPanelContainer, iTextX - iWidth / 2, iTextY - iHeight / 2, iWidth, iHeight, 40, "center", PRIMARY_FONT_COLOUR, PRIMARY_FONT, 1.3, 2, 2, "", true, true, true, false);
