function CHelpPanel() {
    ...
    this._init = function () {
        ...
        if (s_bMobile) {
            ...
            createjs.Tween.get(oLeftFlipperSprite, {
                loop: true
            }).to({
                rotation: -50
            }, 100, createjs.Ease.cubicIn).wait(Math.random() * 500).to({
                rotation: 0
            }, 500, createjs.Ease.cubicIn);
            createjs.Tween.get(oRightFlipperSprite, {
                loop: true
            }).to({
                rotation: 50
            }, 100, createjs.Ease.cubicIn).wait(Math.random() * 500).to({
            ...
            _oText1 = new CTLText(_oPanelContainer, iTextX - iWidth / 2, iTextY - iHeight / 2, iWidth, iHeight, 20, "center", PRIMARY_FONT_COLOUR, PRIMARY_FONT, 1.3, 2, 2, TEXT_HELP1_MOBILE, true, true, true, false);
        } else {
            var oText1Pos = {
                x: -250,
                y: -110
            ...
            var iTextX = oText1Pos.x;
            var iTextY = oText1Pos.y;
            _oText1 = new CTLText(_oPanelContainer, iTextX, iTextY - iHeight / 2, iWidth, iHeight, 20, "left", PRIMARY_FONT_COLOUR, PRIMARY_FONT, 1.3, 2, 2, TEXT_HELP1, true, true, true, false);
        ...
        _oText2 = new CTLText(_oPanelContainer, iTextX - iWidth / 2, iTextY - iHeight / 2, iWidth, iHeight, 20, "center", PRIMARY_FONT_COLOUR, PRIMARY_FONT, 1.3, 2, 2, TEXT_HELP2, true, true, true, false);
    ...
    this.unload = function () {
        ...
        _oListener = _oPanelContainer.off("mousedown", function () {
            _oParent._onExitHelp()
        });
        _oListenerFade = _oFade.off("mousedown", function () {
            _oParent._onExitHelp()
        });
    };
