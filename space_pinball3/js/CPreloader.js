function CPreloader() {
    ...
    this._init = function () {
        ...
        s_oSpriteLibrary.addSprite("progress_bar", "./space_pinball3/sprites/progress_bar.png");
        s_oSpriteLibrary.addSprite("200x200", "./space_pinball3/sprites/200x200.jpg");
        s_oSpriteLibrary.addSprite("but_start", "./space_pinball3/sprites/but_start.png");
